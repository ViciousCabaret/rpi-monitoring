...
from file_locker import ProcessLock
...
if __name__ == '__main__':
    with ProcessLock('upload_files_to_google_drive_command.lock'):
        ...
        monitoring_recordings = MonitoringRecording.get_ready_to_send()
